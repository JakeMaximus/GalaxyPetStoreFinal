<?php 
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        //mysqli fetch array = mysqli_real_escape_string/ mysqli real_escape_string is used to exclude the escape character
        ...
        // only 1 password and only 1 username that's why use 1
        if ($rowCount == 1) {
