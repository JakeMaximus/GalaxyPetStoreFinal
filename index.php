...
<body>
    ...
    <section class="home" id="home">
        ...
        <div class="content">
            ...
            <a href="Main Features/Pet/pets.php" class="btn">Shop now</a>
        </div>
    ...
    <section class="product" id="product">
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <h3>Blue & Yellow Macaw Parrot</h3>
                <div class="stars">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
    ...
    <section class="categories" id="categories">
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <h3>Collars</h3>
                <p>upto 45% off</p>
                <a href="Main Features/Accessories & Toys/cats.php" class="btn">click here</a>
            </div>
            ...
            <div class="box">
                ...
                <h3>leashes</h3>
                <p>upto 45% off</p>
                <a href="Main Features/Accessories & Toys/dogs.php" class="btn">click here</a>
            </div>
            ...
            <div class="box">
                ...
                <h3>Cage</h3>
                <p>upto 45% off</p>
                <a href="Main Features/Accessories & Toys/birds.php" class="btn">click here</a>
            </div>
            ...
            <div class="box">
                ...
                <h3>Toys</h3>
                <p>upto 45% off</p>
                <a href="Main Features/Accessories & Toys/toys.php" class="btn">click here</a>
            </div>
